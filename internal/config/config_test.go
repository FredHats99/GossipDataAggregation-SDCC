...
func TestLoadFromPathOrEnv_FileAndEnvOverride(t *testing.T) {
	...
	if cfg.AntiEntropy != 5000 {
		t.Fatalf("unexpected anti-entropy interval override: %d", cfg.AntiEntropy)
	}
	if cfg.Fanout != 4 {
